...
var convertElementToRawTextWithColor = require("./raw-text").convertElementToRawTextWithColor;
...
exports.extractRawTextWithColor = extractRawTextWithColor;
...
function extractRawTextWithColor(input) {
    return unzip.openZip(input)
        .then(docxReader.read)
        .then(function(documentResult) {
            return documentResult.map(convertElementToRawTextWithColor);
        });
}
